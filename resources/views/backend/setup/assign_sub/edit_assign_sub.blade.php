            ...
            <!-- Basic Forms -->
             <div class="box">
               <div class="box-header with-border">
                 <h4 class="box-title">Edit Subject Assignment</h4>
               ...
               <div class="box-body">
                 <div class="row">
                   <div class="col">
                       <form method="POST" action="{{ route('assign.subject.update',$editData[0]->student_class_id) }}">
                        @csrf
                         <div class="row">
                           <div class="col-12">	
                                        ...
                                        <div class="controls">
                                            <select name="student_class_id"  required="" class="form-control">
                                                ...
                                                @foreach ($student_classes as $class)
                                                    <option value="{{ $class->id }}" {{ ($editData['0']->student_class_id
                                                        ...
                                                        <div class="controls">
                                                            <select name="subject_id[]"  required="" class="form-control">
                                                                ...
                                                                @foreach ($subjects as $subject)
                                                                    <option value="{{ $subject->id }}" {{ ($edit->subject_id ==
