...
<script type="text/javascript">
  $(document).on('click','#search', function(){
    ...
    $.ajax({
      ...
      type: "GET",
      data: {'year_id':year_id, 'student_class_id':student_class_id, 'assign_subject_id':assign_subject_id, 'exam_type_id':exam_type_id}, //student_class_id matches the id on the form above.
